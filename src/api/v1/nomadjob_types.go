...
// NomadJobSpec defines the desired state of NomadJob
...
// NomadJobStatus defines the observed state of NomadJob
...
type NomadJob struct {
	...
	Spec   NomadJobSpec   `json:"spec,omitempty"`
	Status NomadJobStatus `json:"status,omitempty"`
}
